 ...
 return (
   <div className="app-root">
     ...
     <header className="top-bar">
       <h1 className="title">GoBirdie Flight Lab</h1>
       <p className="sub">
         Public demo — coarse RK4 physics for exploring inputs, not production carry.
       </p>
     </header>
     ...
     <div className="grid">
       <div>
         ...
         <p className="section-label">Demo ball tweaks</p>
         <LabeledInput label="Surface wear [0–1]" value={wearStr} onChange={setWearStr} />
         <LabeledInput label="Lift multiplier ×" value={lutClStr} onChange={setLutClStr} />
         <LabeledInput label="Drag multiplier ×" value={lutCdStr} onChange={setLutCdStr} />
         <p className="stat-muted" style={{ margin: '0 0 0.75rem' }}>
           Coarse demo integrator — trajectories are illustrative, not field-calibrated.
         </p>
       </div>
           ...
           {last ? (
             <>
               ...
               <p className="stat-line">
                <span className="stat-k">Reference carry</span> {last.shot.anchorCarryM.toFixed(2)} m (input only).
               <br />  <span className="stat-k">Physics carry</span> {last.shot.carryM.toFixed(2)} m.
               </p>
               <p className="stat-line">
